...
Sun Tzu dice: _"En la batalla, solo hay dos métodos de ataque: lo directo (Zheng) y lo indirecto (Qi); sin embargo, estos dos en combinación dan lugar a una serie interminable de maniobras."_
...
1. **Método Directo (Zheng)**:
    ...
    - _Por qué_: No ganamos nada reinventando el login o el guardado de mensajes.
...
2. **Método Indirecto (Qi)**:
    ...
    - _Por qué_: Aquí es donde el usuario dice "Wow". Aquí ganamos la batalla.

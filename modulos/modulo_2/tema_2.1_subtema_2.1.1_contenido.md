...
Sun Tzu dice: _"Los antiguos guerreros hábiles primero se hacían invencibles a sí mismos, y luego esperaban a descubrir la vulnerabilidad del enemigo"_.
...
Guardar logs o bases de datos _dentro_ del sistema de archivos del contenedor.

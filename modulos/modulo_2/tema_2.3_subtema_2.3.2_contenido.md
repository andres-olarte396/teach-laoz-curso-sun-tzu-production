...
Sun Tzu dice: _"Si el enemigo se prepara a la izquierda, será débil a la derecha... Si se prepara en todas partes, será débil en todas partes"_.
Y la máxima: _"La superioridad numérica relativa es la esencia de la táctica"_.

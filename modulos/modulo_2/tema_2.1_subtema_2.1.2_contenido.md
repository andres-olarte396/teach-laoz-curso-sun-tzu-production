...
Sun Tzu dice: *"El experto en defensa se esconde en las profundidades de la tierra; el experto en ataque se mueve desde las alturas del cielo"*.
...
-   **Semana 3**: El PM quiere lanzar una feature "beta" súper riesgosa.
    -   *Decisión SRE*: Riesgo estimado de caída 30 min. Budget restante 13 min.
    -   *Veredicto*: **DENEGADO**. No tienes saldo para ese riesgo. Mejora tus tests primero.
...
-   **Sun Tzu**: *"Si las órdenes son consistentes, las tropas obedecen. Si no, desconfían."*

...
1.  **Capa 1**: Preguntar "¿Por qué?".
    ...
    -   *Solución*: "En lugar de IA costosa, ¿qué tal un switch manual al registrarse: 'Soy Team Perro / Team Gato'?" (Solución de UX, 0 IA).
...
-   **ROI**: 3 días * 8 horas * $50 = $1200 USD gastados para ganar 3ms de tiempo de CPU irrelevante. ROI Negativo masivo.

...
¿Cuál es el costo *real* de decir "Sí" a ese cambio?
...
### Respuesta 1
**Correcta: b) $15,000**
**Explicación**: El Costo de Retraso siempre suma el *Burn-rate* (lo que gastas manteniento las luces encendidas, $10k) más el *Opportunity Cost* (lo que hubieras ganado si estuvieras en el mercado, $5k). Ignorar el costo de oportunidad es el error más común de los managers novatos.

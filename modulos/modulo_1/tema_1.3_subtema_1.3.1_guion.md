...
Ganar sin luchar es resolver el problema ANTES de que se convierta en código.
Hoy aprendemos a Resolver en Capas.

---

### 03:00 - LAS 3 CAPAS DEL CONFLICTO

**[LOCUTOR]**:
Imagina un árbol de decisión.
...
**[LOCUTOR]**:
Si no, bajamos a la **Capa 2: Arquitectura**.
¿Podemos comprar la solución? ¿Existe una API o Saas que lo haga?
Configurar es más barato que construir. "Ganar mediante estrategia".

**[LOCUTOR]**:
Solo si fallan las anteriores, bajamos a la **Capa 3: Código**.
Aquí es la trinchera. Aquí sudas sangre. Si llegas aquí, asegúrate de que valía la pena.

---

### 08:00 - EL SÍNDROME DEL HÉROE

**[LOCUTOR]**:
Cuidado con el Síndrome del Héroe.
Ese dev que se queda hasta las 3 AM escribiendo un algoritmo complejo para algo que se podía resolver con un excel... no es un héroe. Es un pasivo estratégico.

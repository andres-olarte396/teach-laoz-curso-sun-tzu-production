...
Sun Tzu dice: _"El general inteligente se asegura de que sus tropas se alimenten del enemigo"_. Nosotros interpretamos esto como usar recursos externos (Open Source, Cloud Services) y automatización para reducir la carga logística propia.
...
- **Sun Tzu**: _"Si las órdenes no son claras, la culpa es del general."_

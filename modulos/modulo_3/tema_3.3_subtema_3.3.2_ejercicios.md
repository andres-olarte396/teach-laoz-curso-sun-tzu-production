...
2.  **Incident Commander (IC): Ana**. Como CTO tiene la autoridad para tomar decisiones difíciles (ej. apagar el sitio). *Advertencia*: Debe resistir la tentación de "micro-managear" a Beto. Su rol es coordinar, no teclear.
...
3.  *Nadie* debe tener acceso root directo a la DB excepto un proceso de "Break-glass" auditado.
